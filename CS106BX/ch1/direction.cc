 ...
 *  appear in the text. To ensure that there is only a single source 
 *  for these code fragments, this test program uses the shared copy of 
 *  direction.h and direction.cpp files.
 */
