 ...
 * output by displaying three diferent constants(pi, the speed 
 * if light in meters/second, and the fine-structure constant).
 * These constants are chosen because they illustrate a range of 
 * exoponent scales.
 */
...
int main() {
   ...
   printPrecisionTable(); /* Function's call */
 ...
 * ----------------------------
 * Generates a simple precision tae for the current cout settings.
 */
