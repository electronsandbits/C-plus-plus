 ...
 *
 * 2. If the word begins with a consonant, extract the set of consonants
 ...
 */
 ...
 int main() {
    ...
    getline(cin, line);
    string translation = lineToPigLatin(line); /* Function's output */
 ...
 * sets start to -1 to indicate that the beginning of the current word has 
 ...
 * using the rules specified in the text. The translated word is
 ...
 * If the word does not contain a vowel, findFirstVowel returns -1.
 */
 ...
 * Usage: if (isVowel(ch))...
 * --------------------------
 * Returns true if the characters ch is a vowel.
 */
